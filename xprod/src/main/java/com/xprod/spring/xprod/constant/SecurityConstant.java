...
public class SecurityConstant {
	...
	public static final String [] PUBLIC_URLS = {"/user/login","/user/register","/user/resetpassword/**, /user/image/**"}; //URL QUE NE VOULONS PAS BLOQUER
																														   // Et we allow anything after /**
}
